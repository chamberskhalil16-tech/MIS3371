...
function validateFirstName()
{
    ...
    if (firstN == "")
        {document.getElemenyById("First-Name-error").innerHTML = "Please enter your First name"
        return false;}
...
function validateLastName() 
{
    ...
    if (LastN == "")
        {document.getElemenyById("Last Name-error").innerHTML = "Please enter your Last name"
        return false;}
    //Ensures the character limit of 2 to 30 were entered
...
function validateCity()
{
    ...
    if (firstN == "")
        {document.getElemenyById("city-error").innerHTML = "Please enter your city name"
        return false;}
...
{ 
    ...
    if (!zip) 
    {document.getElementById("Zipcode-error").innerHTML = "Enter your Zip Code";
        return false;}
...
function validateEmail()
{
    ...
    if(email == "")
    {document.getElemenyById("email-error").innerHTML = "Enter an Email Address"
    return false;}

    //Matches Email to Email Pattern
    else if (!email.match(emailP))
    {document.getElemenyById("email-error").innerHTML = "Email Invalid, Enter a valid Email"
    return false;}
